...
class BorrowRules(models.Model):
    ...
    day_fine = models.DecimalField(max_digits=4,decimal_places=2,default=0.1)
...
class Account(models.Model):
    ...
    account_satus = models.CharField("account status",max_length=2,choices=ACCOUNT_STATUS_CHOICES,default='CP')
